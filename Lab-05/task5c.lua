...
hb= 2*s/bc
hc= 2*s/ac
ma=math.sqrt(2*bc^2+2*ac^2-ab^2)/2
mb=math.sqrt(2*ab^2+2*ac^2-bc^2)/2
mc=math.sqrt(2*bc^2+2*ab^2-ac^2)/2
...
rvu= math.sqrt(((p/2 -ab)*(p/2-bc)*(p/2-ac))/(p/2))
rvn= (ab*bc*ac)/(4* math.sqrt(p/2*(p/2-ab)*(p/2-bc)*(p/2-ac)))
print("Радиус вписаной окружности: ", rvu)
print("Радиус описанной окружности: ", rvn)

ugla = math.deg(math.asin((2*s)/(ab*ac)))
uglb = math.deg(math.asin((2*s)/(bc*ab)))
uglc = math.deg(math.asin((2*s)/(bc*ac)))
print("Градусная мера угла А равна: ", math.floor(ugla+0.5))
print("Градусная мера угла B равна: ", math.floor(uglb+0.5))
print("Градусная мера угла C равна: ", math.floor(uglc+0.5))
